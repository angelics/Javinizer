...
if [ -f /config/jvSettings.json ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvSettings.json /config/jvSettings.json
fi
...
if [ -f /config/jvUncensor.csv ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvUncensor.csv /config/jvUncensor.csv
fi
...
if [ -f /logs/jvHistory.csv ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvHistory.csv /logs/jvHistory.csv
fi
...
if [ -f /logs/jvLog.log ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvLog.log /logs/jvLog.log
fi
...
if [ -f /config/jvGenres.csv ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvGenres.csv /config/jvGenres.csv
fi
...
if [ -f /config/jvTags.csv ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvTags.csv /config/jvTags.csv
fi
...
if [ -f /config/jvThumbs.csv ]; then
  ...
  cp /root/.local/share/powershell/Modules/Javinizer/2.4.10/jvThumbs.csv /config/jvThumbs.csv
fi
